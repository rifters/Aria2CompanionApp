...
internal static class Notifications
{
    ...
    public static void ShowDownloadStarted(string filename)
    {
        Show("Download Started", filename, ToolTipIcon.Info);
    }

    public static void ShowDownloadComplete(string filename)
    {
        Show("Download Complete", filename, ToolTipIcon.Info);
    }

    public static void ShowDownloadError(string filename)
    {
        Show("Download Error", $"{filename} encountered an error.", ToolTipIcon.Error);
    }
